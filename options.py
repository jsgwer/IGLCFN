...
parser.add_argument('--freeze_flag',type = bool,default=False, help = 'perform lr decay in each milestone')


parser.add_argument('--batch_size',type=int, default=8, help='batch size for dataloader')
parser.add_argument('--num_workers',type=int,default=1, help = 'num of worker for dataloader')
parser.add_argument('--epoch',type=int,default=200, help='total epoch of training')
